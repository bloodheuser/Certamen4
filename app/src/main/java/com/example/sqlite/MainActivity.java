...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> categoria = new ArrayAdapter<>(this, android.R.layout.simple_spinner_item, CategoriaS);
        Categoria.setAdapter(categoria);

        String [] UbicacionS = {"Seleccione:", "Estante A1", "Estante A2", "Estante A3", "Estante A4", "Estante A5"};
        ArrayAdapter<String> ubicacion = new ArrayAdapter<>(this, android.R.layout.simple_spinner_item, UbicacionS);
        Ubicacion.setAdapter(ubicacion);
    }
    ...
    public void RegistrarProducto(View view) {
        ...
        Cursor cursor = BaseDatos.rawQuery("SELECT * FROM Inventario_Bodega WHERE ID=?", new String[]{IDproducto});
    ...
    public void ModificarProducto(View view){
        ...
        if (!IDproducto.isEmpty() && !NombreProducto.isEmpty() && !CategoriaS.equals("Seleccione:") && !cantidad.equals("") && !precio.equals("") && !ubicacion.equals("Seleccione:")){
            ...
            if (Update == 1){
                Toast.makeText(this, "ID del producto " + IDproducto + " Se ha actualizado.", Toast.LENGTH_SHORT).show();
                ID.setText("");
                Nombre.setText("");
                Categoria.setSelection(0);
                Cantidad.setText("");
                ...
                Toast.makeText(this, "El ID no se ha encontrado", Toast.LENGTH_SHORT).show();
                BaseDatos.close();
            }
        } else {
